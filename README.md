...
- `ENV`  <span style="color: cyan;">unordered\_map\<string, string\></span>: Contains all environment variables.
- `ARGV` <span style="color: cyan;">vector<string></span>: Contains the arguments passed into the program.
